    ...
    begin
      ...
      respond_to do |format|
        if fax_record.save
          ...
          audit_trails_attributes = {action: __method__, actor: Rails.application.class.parent_name, actor_type: 0, event: "new fax request: #{params.inspect}", event_type:'info'}
          ...
          audit_trails_attributes = {action: __method__, actor: Rails.application.class.parent_name, actor_type: 0, event: "new fax request: #{params.inspect}", event_type:'error'}
